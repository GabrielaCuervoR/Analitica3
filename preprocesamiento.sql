...
JOIN manager_survey_data AS mgr ON gd.employeeid = mgr.employeeid
JOIN employee_survey_data AS emp ON gd.employeeid = emp.employeeid
JOIN retirement_new AS ret ON gd.employeeid = ret.employeeid;
